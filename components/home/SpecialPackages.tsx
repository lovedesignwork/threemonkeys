...
const specialPackages = [
  {
    ...
    description: 'An intimate candlelit experience for two, featuring a curated 5-course menu with champagne and stunning rainforest views.',
    image: '/images/Random images/32_resize.jpg',
    features: ['5-Course Menu', 'Champagne', 'Private Table', 'Rose Petals'],
    price: 'From ฿4,500',
    href: '/packages/romantic-dinner',
  },
  {
    id: 'birthday-celebration',
    icon: Cake,
    title: 'Birthday Celebration',
    description: 'Make your special day unforgettable with a personalized birthday package including cake, decorations, and surprises.',
    image: '/images/Random images/33_resize.jpg',
    features: ['Custom Cake', 'Decorations', 'Photo Session', 'Special Menu'],
    price: 'From ฿3,500',
    href: '/packages/birthday-celebration',
  },
  {
    id: 'private-event',
    icon: Users,
    title: 'Private Events',
    description: 'Host your corporate gathering, family reunion, or special occasion in our exclusive private dining spaces.',
    image: '/images/Random images/34_resize.jpg',
    features: ['Exclusive Venue', 'Custom Menu', 'AV Equipment', 'Dedicated Staff'],
    price: 'From ฿15,000',
    href: '/packages/private-events',
  },
];
