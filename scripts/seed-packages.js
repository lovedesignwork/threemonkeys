...
const packages = [
  ...
  { id: 'bamboo-pavilion', name: 'Bamboo Pavilion Exclusive Seat', description: 'Brand new exclusive bamboo pavilion seating.', price: 1000, duration: '1-2 hours', category: 'combined', image_url: '/images/by_slide/slide_15/bamboopav2.jpg' },
  { id: 'zone-6', name: 'ZONE 6 (T)', description: 'Perfect meeting zone for medium-sized groups. Ideal for gatherings, celebrations, and business dinners.', price: 1000, duration: 'up to 4 hours', category: 'combined', image_url: '/images/by_slide/slide_30/zone6_1.jpg' },
  { id: 'zone-7', name: 'ZONE 7 (Z)', description: 'Our largest meeting zone, perfect for large groups, events, and celebrations up to 50 persons.', price: 1000, duration: 'up to 4 hours', category: 'combined', image_url: '/images/by_slide/slide_25/zone7_4_resize.jpg' },
  { id: 'monkey-hilltop', name: 'Monkey Hill Top', description: 'Elevated hilltop dining with panoramic views of the surrounding rainforest.', price: 1000, duration: '1-2 hours', category: 'combined', image_url: '/images/by_slide/slide_40/monkeyhilltop1.jpg' },
  { id: 'rooftop-romantic', name: 'Rooftop Romantic Dinner', description: 'Romantic dining on our rooftop with stunning views.', price: 1000, duration: 'up to 4 hours', category: 'romantic', image_url: '/images/by_slide/slide_35/romantictop1.jpg' },
  { id: 'exclusive-romantic-zone-7', name: 'EXCLUSIVE ROMANTIC AREA ZONE 7', description: 'Exclusive romantic area within Zone 7.', price: 1000, duration: 'up to 4 hours', category: 'romantic', image_url: '/images/by_slide/slide_20/zone7romantic1.jpg' },
  // Open Seating
  { id: 'indoor-seat', name: 'Indoor Seat', description: 'Climate-controlled indoor seating with an inviting ambience.', price: 1000, duration: 'up to 4 hours', category: 'combined', image_url: '/images/by_slide/slide_45/indoor1.jpg' },
  { id: 'outdoor-seat', name: 'Outdoor Seat', description: 'Open-air outdoor seating surrounded by nature.', price: 1000, duration: 'up to 4 hours', category: 'combined', image_url: '/images/by_slide/slide_50/outdoor1.jpg' },
  // Special Packages
